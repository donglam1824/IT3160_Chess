...
class MoveSimulator:
    ...
    def simulatedMove(board , move):
        ...
        MoveSimulator.past_move_stack.append(past_move)

    def revertPastMove(board, reverted_move : PastMove = None):
        reverted_move = MoveSimulator.past_move_stack.pop()
